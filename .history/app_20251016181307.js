...
const crypto = require("crypto"); // <- add this at the top of app.js
// Routes
...
app.use(
  helmet({
    contentSecurityPolicy: {
      directives: {
        "script-src": ["'self'", "https://cdn.tailwindcss.com", (req, res) => `'nonce-${res.locals.nonce}'`],
        "style-src": ["'self'", "https://cdn.tailwindcss.com", (req, res) => `'nonce-${res.locals.nonce}'`],
      },
    },
  })
);

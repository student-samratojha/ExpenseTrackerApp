  ...
  try {
    ...
    if (
      ...
      captchacode.trim().toLowerCase() !== storedCaptcha.toLowerCase()
       ...
       const captcha = genCaptcha();  return res.render("register", {
        captcha,
    ...
    // Email validation
    if (!email.endsWi
            res.cookie("captcha", captcha, { httpOnly: true });th("@gmail.com")) {
    ...
    if (existUser) {
      ...
      return res.render("login", {      return res.render("register", {
        captcha,
        error_msg:
